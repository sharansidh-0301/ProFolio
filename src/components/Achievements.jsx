...
export const Achievements = () => {
    ...
    const achievements = [
    {
      ...
      description: 'Shortlisted among 1,028 teams from 50,000+ participants for the Grand Finale ( Hardware Edition ) in Noida,  New Delhi.',
      date: '2023',
      icon: '🏆',
    ...
    },
     {
      ...
      description: 'Awarded 1st prize in a National-Level Technical Symposium at Mailam Engineering College, Mailam.',
      date: '2025',
      icon: '🚀',
    ...
    },
     {
      ...
      description: 'Successfully led a team of 8 developers on enterprise-level projects',
      date: '2020-2023',
      icon: '👥',
   ...
   
    {
      ...
      description: 'Published technical articles with 10k+ views on modern web development',
      date: '2023',
      icon: '📝',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {achievements.map((achievement, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${achievement.color} rounded-xl opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>
              ...
              <div className="relative z-10">
                ...
                <div className="absolute inset-0 bg-slate-900/95 backdrop-blur-sm rounded-xl p-6 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <button  onClick={() => setOpenIdx(idx)} className="text-sm text-purple-300 cursor-pointer" >Click to learn more</button>
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-2">
                <div className="relative bg-gradient-to-br from-purple-50 to-white rounded-3xl shadow-2xl p-6 sm:p-10 max-w-lg w-full animate-fade-in">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    />
                    <h3 className="text-2xl font-bold text-purple-700 mb-2 text-center">{achievement[openIdx].title}</h3>
                    <p className="text-gray-700 text-center mb-4">{data[openIdx].details}</p>
                    <button
