  ...
  {modal && (
      <div className="fixed inset-0 flex items-center  bg-white/30 backdrop-blur-sm  justify-center z-50">
        ...
        <div className="absolute bg-white p-6 max-w-md w-full ">
          ...
          <p lassName="text-gray-600 mb-4">Hello Every One This is Sharan Sidh</p>
          <button  onClick={toggleModal} className="relative left-96 -top-24 bg-white-500 text-black  px-4 py-2 cursor-pointer hover:bg-red-500   hover:text-white transition duration-100">X</button>
        </div>
      </div>
        ...
        <p className='aubrey-regular text-3xl'>2022 - 2026  </p>
            ...
            <div className="flex justify-center space-x-4">
                <button onClick={toggleModal} className="cursor-pointer bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-300">About Me</button>
