...
export const Home = () => {
  return (
    <>
        <div className='absolute top-1/2 left-1/4 transform -translate-x-1/2 -translate-y-1/2 bg-white/30 backdrop-blur-sm rounded-lg shadow-lg p-8 max-w-md w-full'>
         <div className="body">
            <div className="flex items-center justify-center mb-6">
                <img src={Sidh} alt="Profile" className="w-24 h-24 rounded-full shadow-lg" />
            </div>
